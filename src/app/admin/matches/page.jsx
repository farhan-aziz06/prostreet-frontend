          ...
          <div className='lg:flex items-center justify-between gap-5 px-8'>
            ...
            <div className='xl:hidden flex items-center gap-2 mb-5'>
              ...
              <div className="relative">
                <button
                  className="flex items-center justify-between gap-2 xl:gap-6 px-2 md:px-5 py-2 md:py-3 text-sm font-medium bg-transparent border border-green-700 rounded-md"
              ...
              {/* Sport Type Selector */}
              <button className="flex items-center justify-between gap-2 xl:gap-6 px-2 md:px-5 py-2 md:py-3 text-sm font-medium bg-transparent border border-green-700 rounded-md">
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10">
          <div className="bg-[#222530] p-6 md:py-16 rounded-lg shadow-lg md:w-[60%] lg:w-[40%] m-5 text-center border border-[#4F4E4E]">
            <h2 className="text-lg font-semibold mb-4 text-white">Do you really want to delete this item?</h2>
