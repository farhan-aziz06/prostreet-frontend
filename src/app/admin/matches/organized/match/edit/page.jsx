    ...
    return (
        <div className="bg-[#1A1D26] flex items-center justify-center p-6">
            <div className="w-full bg-[#1A1D26] rounded-lg shadow-lg">
                ...
                {/* Comments Section */}
                <div className="bg-[#1A1D26] p-6 rounded-b-lg px-10 md:flex ml-12 md:ml-0 items-center justify-around">
                    <div className="my-4 ">
                ...
                <div className="bg-[#1A1D26] p-5 ml-14 md:ml-0 md:flex justify-end">
